...
* [微服务](microservice.md#微服务)
  * [什么是微服务](microservice.md#什么是微服务)
  * [单体应用的拆分](microservice.md#单体应用的拆分)
  * [微服务的挑战](microservice.md#微服务的挑战)
  * [微服务架构](microservice.md#微服务架构)
  * [服务描述](microservice.md#服务描述)
  * [注册中心](microservice.md#注册中心)
    * [注册中心原理](microservice.md#注册中心原理)
    * [注册中心选型](microservice.md#注册中心选型)
  * [服务框架](microservice.md#服务框架)
  * [服务监控](microservice.md#服务监控)
  * [服务追踪](microservice.md#服务追踪)
    * [原理](microservice.md#原理)
    * [架构](microservice.md#架构)
  * [服务治理](microservice.md#服务治理)
    * [节点管理](microservice.md#节点管理)
    * [负载均衡](microservice.md#负载均衡)
    * [服务路由](microservice.md#服务路由)
    * [服务容错](microservice.md#服务容错)
  * [平台化](microservice.md#平台化)
* [如何落地](microservice.md#如何落地)
  * [组建合适的技术团队](microservice.md#组建合适的技术团队)
  * [从一个案例入手](microservice.md#从一个案例入手)
  * [做好技术取舍](microservice.md#做好技术取舍)
  * [采用DevOps](microservice.md#采用devops)
  * [统一微服务治理平台](microservice.md#统一微服务治理平台)
* [ServiceMesh](microservice.md#servicemesh)
...
注册中心实现方式 注册中心的实现主要涉及几个问题：注册中心需要提供哪些接口，该如何部署；如何存储服务信息；如何监控服务提供者节点的存活；如果服务提供者节点有变化如何通知服务消费者，以及如何控制注册中心的访问权限。下面我来一一给你讲解。
