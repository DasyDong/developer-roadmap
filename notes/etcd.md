...
* [etcd](etcd.md#etcd)
  * [Etcd 主要功能](etcd.md#etcd-主要功能)
  * [Etcd 基于 RAFT 的一致性](etcd.md#etcd-基于-raft-的一致性)
  * [Etcd v3 存储，Watch 以及过期机制](etcd.md#etcd-v3-存储watch-以及过期机制)
  * [Etcd，Zookeeper，Consul 比较](etcd.md#etcdzookeeperconsul-比较)
  * [Etcd 使用注意事项](etcd.md#etcd-使用注意事项)
  * [参考文档](etcd.md#参考文档)
...
![etcdv3](../.gitbook/assets/etcd-v3.png)
