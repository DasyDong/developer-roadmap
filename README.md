- [Python基础](#python基础)
    - [文件操作](#文件操作)
        ...
        - [2.返回该文件夹中所有文件的路径](#2返回该文件夹中所有文件的路径)
        - [3.设计实现遍历目录与子目录，抓取.pyc文件](#3设计实现遍历目录与子目录抓取pyc文件)
    - [模块与包](#模块与包)
        - [4.输入日期， 判断这一天是这一年的第几天？](#4输入日期-判断这一天是这一年的第几天)
        - [5.打乱一个排好序的list对象alist？](#5打乱一个排好序的list对象alist)
    - [Python语言基本](#python语言基本)
        - [6.现有字典 d= {'a':24,'g':52,'i':12,'k':33}请按value值进行排序?](#6现有字典-d-a24g52i12k33请按value值进行排序)
        - [7.字典推导式](#7字典推导式)
        - [8.请反转字符串 "aStr"?](#8请反转字符串-"astr")
        ...
        - [13.列出 5 个常用 Python 标准库?](#13列出-5-个常用-python-标准库)
        - [14.Python的内建数据类型有哪些?](#14python的内建数据类型有哪些)
        - [15.简述 with 方法打开处理文件帮我我们做了什么？](#15简述-with-方法打开处理文件帮我我们做了什么)
        - [16.Python的可变和不可变数据类型？](#16python的可变和不可变数据类型)
        - [17.Python 获取当前日期？](#17python-获取当前日期)
        - [18.谈谈对 Python 的了解和其他语言的区别](#18谈谈对-python-的了解和其他语言的区别)
        - [19.说说你知道的Python3 和 Python2 之间的区别](#19说说你知道的python3-和-python2-之间的区别)
        - [20.了解 Python 之禅么？](#20了解-python-之禅么)
        - [21.了解 docstring 么？](#21了解-docstring-么)
        - [22.了解类型注解么？](#22了解类型注解么)
        - [23.例举你知道 Python 对象的命名规范，例如方法或者类等](#23例举你知道-python-对象的命名规范例如方法或者类等)
        - [24.例举几个规范 Python 代码风格的工具](#24例举几个规范-python-代码风格的工具)
        - [25.一个编码为 GBK 的字符串 S，要将其转成 UTF-8 编码的字符串，应如何操作？](#25一个编码为-gbk-的字符串-s要将其转成-utf-8-编码的字符串应如何操作)
        - [26.用正则切分字符串去除非符号](#26用正则切分字符串去除非符号)
        - [27.单引号、双引号、三引号的区别？](#27单引号、双引号、三引号的区别)
        - [28.[[1,2],[3,4],[5,6]]一行代码展开该列表，得出[1,2,3,4,5,6]](#28[[12][34][56]]一行代码展开该列表得出[123456])
        - [29.哪些不能作为字典的健](#29哪些不能作为字典的健)
        - [30.如何交换字典 {"A"：1,"B"：2}的键和值？](#30如何交换字典-"a"：1"b"：2的键和值)
        - [31.对生成器类型的对象实现切片功能](#31对生成器类型的对象实现切片功能)
        - [32.关于list tuple copy 和 deepcopy 的区别是什么？](#32关于list-tuple-copy-和-deepcopy-的区别是什么)
        - [33.代码中经常遇到的*args, **kwargs 含义及用法。](#33代码中经常遇到的args-kwargs-含义及用法)
        - [34.Python 中会有函数或成员变量包含单下划线前缀和结尾，和双下划线前缀结尾，区别是什么?](#34python-中会有函数或成员变量包含单下划线前缀和结尾和双下划线前缀结尾区别是什么)
        - [35.json 序列化时，可以处理的数据类型有哪些？如何定制支持 datetime 类型？](#35json-序列化时可以处理的数据类型有哪些如何定制支持-datetime-类型)
        - [36.json 序列化时，默认遇到中文会转换成 unicode，如果想要保留中文怎么办？](#36json-序列化时默认遇到中文会转换成-unicode如果想要保留中文怎么办)
        - [37.如果当前的日期为 20190530，要求写一个函数输出 N 天后的日期，(比如 N 为 2，则输出 20190601)](#37如果当前的日期为-20190530要求写一个函数输出-n-天后的日期比如-n-为-2则输出-20190601)
        - [38.python 字典和 json 字符串相互转化方法](#38python-字典和-json-字符串相互转化方法)
        - [39.函数装饰器有什么作用？请列举说明？](#39函数装饰器有什么作用请列举说明)
        - [40.__call__](#40__call__)
        - [41.如何判断一个对象是函数还是方法？](#41如何判断一个对象是函数还是方法)
        - [42.python实现接口 ？](#42python实现接口-)
        - [43.Python 中的反射了解么?](#43python-中的反射了解么)
        - [44.metaclass or type](#44metaclass-or-type)
        - [45.Python中递归的最大次数1000 ?怎么改](#45python中递归的最大次数1000-怎么改)
        - [46.列举 5 个 Python 中的异常类型以及其含义](#46列举-5-个-python-中的异常类型以及其含义)
        - [47.w、a+、wb 文件写入模式的区别](#47w、a、wb-文件写入模式的区别)
        - [48.举例 sort 和 sorted 的区别](#48举例-sort-和-sorted-的区别)
        - [49.在 requests 模块中，requests.content 和 requests.text 什么区别](#49在-requests-模块中requestscontent-和-requeststext-什么区别)
        - [50.python新式类和经典类的区别](#50python新式类和经典类的区别)
        - [51.字符串的操作题目](#51字符串的操作题目)
        - [52.可变类型和不可变类型](#52可变类型和不可变类型)
        - [53.is和==有什么区别？](#53is和有什么区别)
        - [54.求出列表所有奇数并构造新列表](#54求出列表所有奇数并构造新列表)
        - [55.用一行python代码写出1+2+3+10248](#55用一行python代码写出12310248)
        - [56.Python中变量的作用域？（变量查找顺序)](#56python中变量的作用域变量查找顺序)
        - [57.字符串 `"123"` 转换成 `123`，不使用内置api，例如 `int()`](#57字符串-`"123"`-转换成-`123`不使用内置api例如-`int`)
        - [58.Given an array of integers](#58given-an-array-of-integers)
        - [59.统计一个文本中单词频次最高的10个单词？](#59统计一个文本中单词频次最高的10个单词)
        - [60.给定一个任意长度数组，实现一个函数](#60给定一个任意长度数组实现一个函数)
        - [61.写一个函数找出一个整数数组中，第二大的数](#61写一个函数找出一个整数数组中第二大的数)
        - [62.阅读一下代码他们的输出结果是什么？](#62阅读一下代码他们的输出结果是什么)
        - [63.统计一段字符串中字符出现的次数](#63统计一段字符串中字符出现的次数)
        - [64.super函数的具体用法和场景](#64super函数的具体用法和场景)
- [Python高级](#python高级)
    - [元类](#元类)
        - [65.Python中类方法、类实例方法、静态方法有何区别？](#65python中类方法、类实例方法、静态方法有何区别)
    ...
    - [网络编程](#网络编程)
        ...
        - [116.简述浏览器通过WSGI请求动态资源的过程?](#116简述浏览器通过wsgi请求动态资源的过程)
...
- [Web](#web)
    ...
    - [Django](#django)
        ...
        - [134.Django、Flask、Tornado的对比？](#134django、flask、tornado的对比)
...
- [数据结构](#数据结构)
    - [基础](#基础)
        - [150.红黑树](#150红黑树)
    - [实战](#实战)
        - [151.基本排序算法汇总(桶排序,归并,快排,希尔,插入,选择,冒泡)](#151基本排序算法汇总桶排序归并快排希尔插入选择冒泡)
        - [152.数组中出现次数超过一半的数字-Python版](#152数组中出现次数超过一半的数字-python版)
        - [153.求100以内的质数](#153求100以内的质数)
        - [154.无重复字符的最长子串-Python实现](#154无重复字符的最长子串-python实现)
        - [155.通过2个5/6升得水壶从池塘得到3升水](#155通过2个5/6升得水壶从池塘得到3升水)
        - [156.什么是MD5加密，有什么特点？](#156什么是md5加密有什么特点)
        - [157.什么是对称加密和非对称加密](#157什么是对称加密和非对称加密)
        - [158.如何判断单向链表中是否有环？](#158如何判断单向链表中是否有环)
        - [159.斐波那契数列](#159斐波那契数列)
        - [160.如何翻转一个单链表？](#160如何翻转一个单链表)
        - [161.两数之和 Two Sum](#161两数之和-two-sum)
        - [162.搜索旋转排序数组 Search in Rotated Sorted Array](#162搜索旋转排序数组-search-in-rotated-sorted-array)
        - [163.Python实现一个Stack的数据结构](#163python实现一个stack的数据结构)
        - [164.写一个二分查找](#164写一个二分查找)
        - [165.set 用 in 时间复杂度是多少，为什么？](#165set-用-in-时间复杂度是多少为什么)
        - [166.列表中有n个正整数范围在[0，1000]，进行排序；](#166列表中有n个正整数范围在[01000]进行排序；)
- [大数据](#大数据)
    - [实战](#实战)
        - [167.找出1G的文件中高频词](#167找出1g的文件中高频词)
        - [168.一个大约有一万行的文本文件统计高频词](#168一个大约有一万行的文本文件统计高频词)
        - [169.怎么在海量数据中找出重复次数最多的一个？](#169怎么在海量数据中找出重复次数最多的一个)
        - [170.判断数据是否在大量数据中](#170判断数据是否在大量数据中)
- [值得一看的文章](#值得一看的文章)
    - [两地书](#两地书)
- [服务发现](#服务发现)
    - [consul](#consul)
...
```
## Python语言基本
### 6.现有字典 d= {'a':24,'g':52,'i':12,'k':33}请按value值进行排序?
```python
...
### 19.说说你知道的Python3 和 Python2 之间的区别
...
### 23.例举你知道 Python 对象的命名规范，例如方法或者类等
...
### 24.例举几个规范 Python 代码风格的工具
pylint，yapf, autopep8, flake8

### 25.一个编码为 GBK 的字符串 S，要将其转成 UTF-8 编码的字符串，应如何操作？
...
### 32.关于list tuple copy 和 deepcopy 的区别是什么？
tuple：
```
a = (1, 2, 3, [4, 5, 6, 7], 8)
a[3] = 3  //typeerror
...
### 33.代码中经常遇到的*args, **kwargs 含义及用法。
args 是 arguments 的缩写，表示位置参数
kwargs 是 keyword arguments 的缩写，表示关键字参数

### 34.Python 中会有函数或成员变量包含单下划线前缀和结尾，和双下划线前缀结尾，区别是什么?
...
### 35.json 序列化时，可以处理的数据类型有哪些？如何定制支持 datetime 类型？
json序列化时，可以处理列表、字典、字符、数值、布尔和None
定制datetime类型↓

### 36.json 序列化时，默认遇到中文会转换成 unicode，如果想要保留中文怎么办？
print(json.dumps(dict_demo, ensure_ascii=False))

### 37.如果当前的日期为 20190530，要求写一个函数输出 N 天后的日期，(比如 N 为 2，则输出 20190601)
```
...
### 44.metaclass or type
https://www.liaoxuefeng.com/wiki/897692888725344/923030550637312

### 45.Python中递归的最大次数1000 ?怎么改
import sys
sys.setrecursionlimit(1500) # set the maximum depth as 1500

### 46.列举 5 个 Python 中的异常类型以及其含义
```
BaseException
 +-- SystemExit
 +-- KeyboardInterrupt
...
### 49.在 requests 模块中，requests.content 和 requests.text 什么区别
...
### 57.字符串 `"123"` 转换成 `123`，不使用内置api，例如 `int()`
方法一： 利用 `str` 函数
```python
def atoi(s):
    num = 0
...
### 138.用的restframework完成api发送时间时区
...
### 148.对cookies与session的了解？他们能单独用吗？
...
### 151.基本排序算法汇总(桶排序,归并,快排,希尔,插入,选择,冒泡)
...
class Solution(object):
    def twoSum(self, nums, target):
        ...
        for i, m in enumerate(nums):
            ...
            _dict[m] = i
```
### 162.搜索旋转排序数组 Search in Rotated Sorted Array
### 163.Python实现一个Stack的数据结构
### 164.写一个二分查找
```
...
if __name__ == "__main__":
    ...
    if binary_chop(lis, 12):
        ...
        print('false')
```
### 165.set 用 in 时间复杂度是多少，为什么？
### 166.列表中有n个正整数范围在[0，1000]，进行排序；
# 大数据
## 实战
### 167.找出1G的文件中高频词
### 168.一个大约有一万行的文本文件统计高频词
### 169.怎么在海量数据中找出重复次数最多的一个？
### 170.判断数据是否在大量数据中
...
![](https://upload-images.jianshu.io/upload_images/13880925-c855aa74d0a019ea.png)
